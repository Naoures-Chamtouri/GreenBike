  ...
  return (
    <div className="ml-10 w-1/3 mt-6">
      ...
      <p className="text-lg mt-3">
        <span className="font-medium text-customGreen-dark">Description:</span>
        {balade.description}
      </p>
      <div className="flex mt-4">
        <FaMapMarkerAlt className="w-4 h-4 text-customGreen-dark" />
        <h2 className="text-sm ml-1">{balade.adresseDepart.nom}</h2>
      </div>
      <div className="flex mt-2">
        <FaFlagCheckered className="w-4 h-4 text-customGreen-dark" />
        <h2 className="text-sm ml-1">{balade.adresseArrivée.nom}</h2>
      </div>
      <div className="flex mt-2">
      ...
      <div className="mt-10">
        ...
        {balade.conseils.map((conseil, index) => (
