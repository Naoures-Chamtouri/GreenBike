...
function PageVeloLocation() {
  ...
  const initialValues = {
    ...
    prix: velo.prixHeure || 0,
    adresseDisponible:
      velo.adresseDisponible.map((adresse) => adresse._id) || [],
    stock: velo.stock || 0,
    ...
    newMarque: '',
    selectedCouleurs: velo.velo.couleur?.map((couleur) => couleur._id) || [],
  };
  ...
  const handleUpdate = async () => {
    ...
    if (formValues.adresseDisponible.length ===0) {
      formIsValid = false;
      console.log('adresse est obligatoire');
    }
    ...
    if (
      !formValues.roue.materiau ||
      !formValues.roue.taille ||
      !formValues.roue.poids
    ) {
      formIsValid = false;
    ...
    if (formIsValid) {
      try {
        ...
        const response = await axios.put(
          `http://localhost:4000/admin/veloLocations/${velo._id}`,
          newVelo,
          {
      ...
      <div>
            ...
            <div className="flex justify-center space-x-6 mb-10">
              ...
              >
                ...
                <Select
                  ...
                  id="categorie-select"
                  value={formValues.categorie._id}
                  name="categorie"
                  label="Categorie"
            ...
            <div className="flex justify-center space-x-6 mb-6">
              <FormControl className="w-1/3" disabled={disabled}>
                ...
                <Select
                  ...
                  id="addresse-select"
                  multiple
                  name="adresseDisponible"
                  value={formValues.adresseDisponible}
                  onChange={handleChange}
                  sx={{
                    '& .MuiSelect-select': {
                      color: 'green',
        ...
        <Accordion expanded>
          ...
          <AccordionDetails className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div>
              {formValues.categorie.nom == 'Vélos Electriques ' && (
                <div>
